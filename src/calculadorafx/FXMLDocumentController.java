...
public class FXMLDocumentController implements Initializable {
    ...
    private void clickEqual(ActionEvent event) {
        ...
        else secondNumber=Double.parseDouble(txtNums.getText());
        operations[0]=false;
        operations[1]=false;
        operations[2]=false;
        operations[3]=false;
    ...
    private void clickNegative(ActionEvent event) {
        if (isNumeric(txtNums.getText())) {
            Double tmpNegDouble = Double.parseDouble(txtNums.getText());
            int tmpNegInt = (int) Double.parseDouble(txtNums.getText());
            if (tmpNegDouble==tmpNegInt) txtNums.setText(String.valueOf(tmpNegInt*-1));
            else txtNums.setText(String.valueOf(tmpNegDouble*-1));
        }
        form.requestFocus();
    }    
    ...
    private void clickDelete(ActionEvent event) {
        if (isNumeric(txtNums.getText())) {
            if (Double.parseDouble(txtNums.getText())!=0) {
    ...
    private void writeNumber(String number) {
        if (firstNumber==0) {
            ...
            txtNums.setText(number);
            secondNumber=Double.parseDouble(txtNums.getText());
    ...
    private void assignNumber() {
        if (isNumeric(txtNums.getText())) {
            if (firstNumber==0) {
                firstNumber=Double.parseDouble(txtNums.getText());
                secondNumber = 0;
            } else {
                if (!opPressed) secondNumber = Double.parseDouble(txtNums.getText());
                else secondNumber=0;
            }
        }           
    }
    ...
    private void calculate() {
        if (operations[0]) txtNums.setText(String.valueOf(firstNumber + secondNumber));
        if (operations[1]) txtNums.setText(String.valueOf(firstNumber - secondNumber));
        if (operations[2]) txtNums.setText(String.valueOf(firstNumber * secondNumber));
        if (operations[3]) {
            if (secondNumber==0) {
                txtNums.setText("Error");
                firstNumber=0;
                secondNumber=0;
                opPressed = false;
                writing = false;
                writing2 = false;
            } else txtNums.setText(String.valueOf(firstNumber / secondNumber));
        }
        firstNumber=0;
    }
